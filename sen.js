...
senku.sendMessage(metdata.id, teks, MessageType.text, {quoted: sen})
console.log(` [ Group Closed ]  In ${metdata.subject}`)
}
else if(!anu.desc == ''){
tag = anu.descOwner.split('@')[0] + '@s.whatsapp.net'
teks = ` [ Group Description Change ] \n\nDeskripsi Group telah diubah oleh Admin @${anu.descOwner.split('@')[0]}\nâ€¢ Deskripsi Baru : ${anu.desc}`
senku.sendMessage(metdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [tag]}, quoted: sen})
...
senku.sendMessage(m.key.remoteJid, `
